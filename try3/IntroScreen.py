...
def currentEmotionWindow():
    ...
    curentEmotionWindow.setWindowTitle("Current Emotion")
    ...
    emoji_label_current = QLabel(emojiArray[5], curentEmotionWindow)  # Set happy emoji
    emoji_label_current.setFont(QFont("Arial", 40))  # Adjust font size for the emoji
    emoji_label_current.setAlignment(Qt.AlignmentFlag.AlignCenter)

    layout = QVBoxLayout()
    layout.addWidget(emoji_label_current)
    curentEmotionWindow.setLayout(layout)
